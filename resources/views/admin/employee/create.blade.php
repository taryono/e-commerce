                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('employee.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6"> 
                                <label class="radio-inline">
                                    <input id="sexF" type="radio" class="radio" name="sex" value="F" required autofocus>Female
                                </label>
                                <label class="radio-inline">
                                    <input id="sexM" type="radio" class="radio" name="sex" value="M" required autofocus>Male
                                </label>
                        ...
                        <div class="form-group"> 
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                &nbsp;
                                <button type="button" onclick="window.location.href='{{route("employee.index")}}'" class="btn btn-primary">
                                    Batal
                                </button> 
                            </div>
                        </div>
